...
var AdminModuleModule = /** @class */ (function () {
    ...
    AdminModuleModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_user_user_component__WEBPACK_IMPORTED_MODULE_3__["UserComponent"], _admin_component__WEBPACK_IMPORTED_MODULE_4__["AdminComponent"], _configuration_configuration_component__WEBPACK_IMPORTED_MODULE_5__["ConfigurationComponent"]],
            providers: [
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.edit = function (id) {
        ...
        this.registerForm = this.formBuilder.group({
            ...
            password: [user.password, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(6)]]
        });
        this.editing = true;
...
var EventRegisterComponent = /** @class */ (function () {
    function EventRegisterComponent(formBuilder, userService, configService, eventService) {
        this.formBuilder = formBuilder;
        this.userService = userService;
        this.configService = configService;
        this.eventService = eventService;
    ...
    Object.defineProperty(EventRegisterComponent.prototype, "stateList", {
        get: function () {
            return this.show ? 'block' : 'none';
        },
        enumerable: true,
    ...
    EventRegisterComponent.prototype.toggle = function () {
        this.show = !this.show;
        if (this.editing && !this.show) {
            this.cleanForm();
        }
    ...
    EventRegisterComponent.prototype.cleanForm = function () {
        this.registerForm = this.formBuilder.group({
            user: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            duration: [this.config.interval, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            date: [this.date, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    Object.defineProperty(EventRegisterComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () { return this.registerForm.controls; },
        enumerable: true,
        configurable: true
    });
    EventRegisterComponent.prototype.edit = function (id) {
        var event = this.eventService.getById(id);
        var sHour = event.date.getHours().toLocaleString();
        var sMinute = event.date.getMinutes().toLocaleString();
        var time = (sHour.length == 1 ? ("0" + sHour) : sHour) + ":" + (sMinute.length == 1 ? ("0" + sMinute) : sMinute);
    ...
    EventRegisterComponent.prototype.delete = function (id) {
        this.eventService.delete(id);
    };
    ...
    EventRegisterComponent.prototype.addMinutes = function () {
        this.indexDate.setTime(this.indexDate.getTime() + (this.config.interval * 60 * 1000));
        this.resetDate();
    };
    EventRegisterComponent.prototype.subMinutes = function () {
        this.indexDate.setTime(this.indexDate.getTime() - (this.config.interval * 60 * 1000));
        this.resetDate();
    };
    EventRegisterComponent.prototype.resetDate = function () {
        if ((this.indexDate.getHours()) < this.config.hourInit) {
            this.indexDate.setTime(this.indexDate.getTime() - (60 * 60 * 1000 * ((24 - this.config.hourEnd) + this.config.hourInit)));
            this.indexDate.setMinutes(this.config.interval);
        }
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"] //<-- import
            ],
            declarations: [
